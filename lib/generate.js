...
var _a = fs_1.default.promises, stat = _a.stat, writeFile = _a.writeFile, readFile = _a.readFile;
...
function generateConfigsInPlace(targetDir) {
    return __awaiter(this, void 0, void 0, function () {
        var packageFiles, nameToLocationMapping, nameToDependencies, _i, packageFiles_1, packagePath, contents, packageRoot, name, deps, _a, _b, depsKey, depsKeys, _c, depsKeys_1, dep, possibleBaseConfigPath, baseConfig, packageNames, _loop_1, _d, _e, _f, packageName, rootBuildConfigPath, rootConfig;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0: return [4 /*yield*/, globby([path_1.default.join(targetDir, "**/package.json"), "!" + path_1.default.join(targetDir, "node_modules"), "!" + path_1.default.join(targetDir, "package.json")])];
                case 1:
                    ...
                    _g.label = 2;
                case 2:
                    if (!(_i < packageFiles_1.length)) return [3 /*break*/, 6];
                                ...
                                case 1:
                                    ...
                                    candidateConfig = {
                                        ...
                                        references: referencableDeps.size ? Array.from(referencableDeps).sort().map(function (d) {
                                            return (d === packageName ? undefined : { path: path_1.default.relative(path_1.default.dirname(tsconfigPath), nameToLocationMapping[d]).replace(/\\/g, "/"), circular: true });
                ...
                case 11:
                    ...
                    rootConfig = {
                        ...
                        references: packageNames.size ? Array.from(packageNames).sort().map(function (d) {
                            return ({ path: path_1.default.relative(path_1.default.dirname(rootBuildConfigPath), nameToLocationMapping[d]).replace(/\\/g, "/") });
                        }) : undefined,
                        compilerOptions: {
                            declaration: true,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, globby([glob, glob + "x"])];
                case 1:
                    tsFiles = _a.sent();
